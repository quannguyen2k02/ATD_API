...
namespace Application.IRepository.LED
{
    public interface ILedModelRepository
    {
        ...
        public Task<PagedResult<LedModel>> GetLedModelAsync(int deviceId, string model, string kb, string fp, int? lastId = null, int pageSize = 20);
        ...
        public Task<PagedResult<LedModel>> GetLedModelsByDeviceIdAsync(int id, int? lastId = null, int pageSize = 20);
